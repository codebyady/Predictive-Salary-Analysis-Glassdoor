...
# -*- coding: utf-8 -*-
"""
Created on Thu May 25 21:30:04 2023
...
gs = GridSearchCV(rf,parameters,scoring='neg_mean_absolute_error',cv=4, error_score='raise')
...
"""
mean_absolute_error(y_test,tpred_lm)
Out[53]: 18.85518999021409

mean_absolute_error(y_test,tpred_lml)
Out[54]: 19.033692547072476

mean_absolute_error(y_test,tpred_rf)
Out[55]: 11.024966442953021

mean_absolute_error(y_test,(tpred_lm+tpred_rf)/2)
Out[56]: 14.304067201966111
"""
